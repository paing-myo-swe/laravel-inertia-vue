<template>
    ...
    <div>
        ...
        <form @submit.prevent="submit" class="mt-7 max-w-md mx-auto">
            <div class="mb-3">
            ...
            <div>
                <button 
                    ...
                    class="rounded-md px-4 py-2 bg-indigo-600 text-sm text-white shadow-sm hover:bg-indigo-500">Save</button>
            </div>
        </form>
    </div>
</template>
